...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		<h4 class="comments-title">
			<?php
				printf( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'understrap' ),
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			<h6 class="screen-reader-text"><?php _e( 'Comment navigation', 'understrap' ); ?></h6>
