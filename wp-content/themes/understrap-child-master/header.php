	...
	<div class="wrapper-fluid wrapper-navbar" id="wrapper-navbar">
		...
		<?php endif; ?>
					...
					<?php if ( is_user_logged_in() ) {
							echo '<button type="button" class="btn btn-outline-secondary navbar-btn" data-toggle="modal" data-target="#logInModal">Sign Out</button>';
					} else {
							echo '<button type="button" class="btn btn-cta navbar-btn" data-toggle="modal" data-target="#logInModal">Sign in</button>';
					}
