...
<?php while ( have_posts() ) : the_post(); ?>
    ...
    <div class="col-sm-8">
  		<?php if ( tribe_embed_google_map() && tribe_address_exists() ) : ?>
  			...
  			<div class="tribe-events-map-wrap">
  				<?php echo tribe_get_embedded_map( $venue_id ); ?>
	...
	<div class="row">
		<div class="col-sm-12">
		<!-- Venue Description -->
		<?php if ( get_the_content('Read More...') ) : ?>
	...
	<!-- Upcoming event list -->
	<a name="classes-anchor"><?php do_action( 'tribe_events_single_venue_before_upcoming_events' ) ?></a>
