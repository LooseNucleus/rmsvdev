...
Event Calendar Attendees pulls the events for your newsletter from a WordPress event calendar plugin installed on your site.
...
Event Calendar Attendees is available as a pro version with lots of extra features to save you even more time and get more people attending your events!
...
[Read Reviews &raquo;](https://eventcalendarnewsletter.com/testimonials/ "Event Calendar Attendees WordPress Plugin")


== Installation ==

You can either search for Event Calendar Attendees in the Plugins --> Add New area, or:
...
5. Go to Event Calendar Attendees and complete the form
...
* Text copy tweaks
* Additional eca_get_excerpt filter
...
= 2.0.1 =
* Using Tribe__Events__Query for ECA
...
* Added eca_admin_capability filter to modify who has access to the events calendar screen
