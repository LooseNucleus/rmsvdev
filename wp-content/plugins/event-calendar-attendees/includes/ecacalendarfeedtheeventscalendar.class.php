<?php
if ( ! class_exists( 'ECACalendarFeedTheEventsCalendar' ) ) {
class ECACalendarFeedTheEventsCalendar extends ECACalendarFeed {
    ...
    function get_events( $start_date, $end_date, $data = array() ) {
	    ...
	    $events = tribe_get_events( apply_filters( 'eca_fetch_events_args-' . $this->get_identifier(), 
      array(
        'posts_per_page' => -1,
        'hide_upcoming' => true,
        'post_status' => 'publish',
