<?php
if ( ! class_exists( 'ECACalendarFeedGoogleCalendarEvents' ) ) {
class ECACalendarFeedGoogleCalendarEvents extends ECACalendarFeed {
    ...
    function get_events( $start_date, $end_date, $data = array() ) {
        ...
        $calendar_posts = get_posts( apply_filters( 'eca_fetch_events_args-' . $this->get_identifier(), array( 'post_type' => 'calendar', 'posts_per_page' => 100 ), $start_date, $end_date, $data ) );
