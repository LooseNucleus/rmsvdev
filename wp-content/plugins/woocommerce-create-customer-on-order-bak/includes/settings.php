...
function cxccoo_admin_page() {
	...
	<form method="post" id="mainform" action="" enctype="multipart/form-data">
		<div class="cxccoo-wrap-settings woocommerce">
			...
			<a class="cxccoo-back" href="<?php echo esc_url( admin_url( 'edit.php?post_type=stored-carts' ) ); ?>"><span class="dashicons dashicons-arrow-left"></span> Back</a>
			
			<h2><?php _e( 'Create Customer on Order', 'create-customer-order' ); ?><span class="dashicons dashicons-arrow-right"></span><?php _e( 'Settings', 'create-customer-order' ); ?></h2>
